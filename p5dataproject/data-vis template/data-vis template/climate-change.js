  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      if (previous != null
        ...
        var x = this.layout.leftMargin + (offset - 1) * segmentWidth;
        var y = this.layout.topMargin;
        var r_width = segmentWidth;
        var r_height = this.layout.bottomMargin - this.layout.topMargin;
