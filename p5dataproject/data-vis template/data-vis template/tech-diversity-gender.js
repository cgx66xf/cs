function TechDiversityGender() {
  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var x = this.layout.leftMargin + this.mapPercentToWidth(company.female);
      var y = lineY;
      var r_width = this.mapPercentToWidth(company.male);
      var r_height = lineHeight - this.layout.pad;
